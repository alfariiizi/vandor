...
import (
	...
	_ "github.com/alfariiizi/vandor/.ckeletin/pkg/config/commands" // Import to trigger init() functions (framework)
	_ "github.com/alfariiizi/vandor/internal/config/commands"      // Import to trigger init() functions (project)
)
